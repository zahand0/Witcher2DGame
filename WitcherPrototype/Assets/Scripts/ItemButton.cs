...
public class ItemButton : MonoBehaviour
{
    ...
    public void Press()
    {
        ...
        if (Chest.instance.chestMenu.activeInHierarchy && Chest.instance.takeMenu.activeInHierarchy)
        {
            Chest.instance.SelectTakeItem(GameManager.instance.GetItemDetails(Chest.instance.itemsForTake[buttonValue]));
        }
    }
}
